...
// Jeg kan ikke helt få denne funktion til at virke med ord. Den virker med tal.
/* 
function sameWords () {
...
function NoOfCharacters () {
    ...
    regex = /[a-zA-Z]/gm;
    arr = text2.match(regex);
    characters.innerHTML = arr.length;
}

NoOfCharacters();

function NoOfEachCharacter () {
    let a = document.getElementById("a");
    let regex2 = /[a]/gmi;
    let a2 = text2.match(regex2);
    a.innerHTML = 'a: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let b = document.getElementById("b");
    regex2 = /[b]/gmi;
    a2 = text2.match(regex2);
    b.innerHTML = 'b: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let c = document.getElementById("c");
    regex2 = /[c]/gmi;
    a2 = text2.match(regex2);
    c.innerHTML = 'c: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let d = document.getElementById("d");
    regex2 = /[d]/gmi;
    a2 = text2.match(regex2);
    d.innerHTML = 'd: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let e = document.getElementById("e");
    regex2 = /[e]/gmi;
    a2 = text2.match(regex2);
    e.innerHTML = 'e: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let f = document.getElementById("f");
    regex2 = /[f]/gmi;
    a2 = text2.match(regex2);
    f.innerHTML = 'f: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let g = document.getElementById("g");
    regex2 = /[g]/gmi;
    a2 = text2.match(regex2);
    g.innerHTML = 'g: ' + a2.length+ ' frequency = (' + (a2.length/arr.length*100) + ')';

    let h = document.getElementById("h");
    regex2 = /[h]/gmi;
    a2 = text2.match(regex2);
    h.innerHTML = 'h: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let i = document.getElementById("i");
    regex2 = /[i]/gmi;
    a2 = text2.match(regex2);
    i.innerHTML = 'i: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let j = document.getElementById("j");
    regex2 = /[j]/gmi;
    a2 = text2.match(regex2);
    j.innerHTML = 'j: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let k = document.getElementById("k");
    regex2 = /[k]/gmi;
    a2 = text2.match(regex2);
    k.innerHTML = 'k: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let l = document.getElementById("l");
    regex2 = /[l]/gmi;
    a2 = text2.match(regex2);
    l.innerHTML = 'l: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let m = document.getElementById("m");
    regex2 = /[m]/gmi;
    a2 = text2.match(regex2);
    m.innerHTML = 'm: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let n = document.getElementById("n");
    regex2 = /[n]/gmi;
    a2 = text2.match(regex2);
    n.innerHTML = 'n: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let o = document.getElementById("o");
    regex2 = /[o]/gmi;
    a2 = text2.match(regex2);
    o.innerHTML = 'o: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let p = document.getElementById("p");
    regex2 = /[p]/gmi;
    a2 = text2.match(regex2);
    p.innerHTML = 'p: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let q = document.getElementById("q");
    regex2 = /[q]/gmi;
    a2 = text2.match(regex2);
    q.innerHTML = 'q: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let r = document.getElementById("r");
    regex2 = /[r]/gmi;
    a2 = text2.match(regex2);
    r.innerHTML = 'r: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let s = document.getElementById("s");
    regex2 = /[s]/gmi;
    a2 = text2.match(regex2);
    s.innerHTML = 's: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let t = document.getElementById("t");
    regex2 = /[t]/gmi;
    a2 = text2.match(regex2);
    t.innerHTML = 't: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let u = document.getElementById("u");
    regex2 = /[u]/gmi;
    a2 = text2.match(regex2);
    u.innerHTML = 'u: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let v = document.getElementById("v");
    regex2 = /[v]/gmi;
    a2 = text2.match(regex2);
    v.innerHTML = 'v: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let w = document.getElementById("w");
    regex2 = /[w]/gmi;
    a2 = text2.match(regex2);
    w.innerHTML = 'w: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let x = document.getElementById("x");
    regex2 = /[x]/gmi;
    a2 = text2.match(regex2);
    x.innerHTML = 'x: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let y = document.getElementById("y");
    regex2 = /[y]/gmi;
    a2 = text2.match(regex2);
    y.innerHTML = 'y: ' + a2.length  + ' frequency = (' + (a2.length/arr.length*100) + ')';

    let z = document.getElementById("z");
    regex2 = /[z]/gmi;
    a2 = text2.match(regex2);
    z.innerHTML = 'z: ' + a2.length + ' frequency = (' + (a2.length/arr.length*100) + ')';
